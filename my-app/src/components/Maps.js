  ...
  if (typeof data == 'object') {
    return (  
        ...
        <div className="flex w-full h-full">
          <iframe className="rounded-xl w-[1000px]" src={`https://api.maptiler.com/maps/5aee923c-5f1e-41cd-a0fe-4212521fed8c/?key=${process.env.REACT_APP_API_MAP}#${zoom}/${data?.coord?.lat}/${data?.coord?.lon}`} ></iframe>
